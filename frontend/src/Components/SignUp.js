    ...
    <div className='flex flex-row justify-center m-32 shadow-2xl rounded-3xl w-[1050px] mx-auto'>
      ...
      <div className=''>
        ...
        <form className='flex flex-col' onSubmit={handleSubmit}>
          <input className='mx-4 px-4 my-2 border border-solid w-auto h-12 rounded-full' type="text" name="fullName" placeholder='Enter Your FullName' value = {formData.fullName} onChange={handleChange} />
          {errors.fullName.length>0?<span className='ml-auto mr-6 text-red-600'>{errors.fullName}</span>:<span></span>}
      ...
      <div className='flex flex-col justify-center m-10 mt-44'>
        ...
        <span className='ml-auto mr-6 cursor-pointer' onClick={handleClick}>Already Have an account? LogIn Now</span>
      </div>
